...
describe('Activity Logger (Exercise)', () => {
  ...
  const { getByTestId } = render(<ActivityLoggerExercise />);
  ...
  it('should have exercise type field', () => {
    waitFor(() => {
      const exerciseField = getByTestId('exerciseField');
      expect(exerciseField).toBeInTheDocument();
    })
  });

  it('should have exercise date field', () => {
    waitFor(() => {
  ...
  it('should have exercise start time field', () => {
    waitFor(() => {
      const startTimeField = getByTestId('startTimeField');
      expect(startTimeField).toBeInTheDocument();
    })
  });

  it('should have exercise end time field', () => {
    waitFor(() => {
      const endTimeField = getByTestId('endTimeField');
      expect(endTimeField).toBeInTheDocument();
    })
  });

  it('should have calorie amount field', () => {
    waitFor(() => {
      const calorieField = getByTestId('calorieField');
      expect(calorieField).toBeInTheDocument();
    })
  });
